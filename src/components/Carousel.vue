  ...
  <div class="carousel-main">
    ...
    >
      <div class="carousel-inner">
        ...
        <div class="carousel-item second" data-bs-interval="20000">
          <div class="carousel-item-section">
            <h2 class="carousel-item-title">
              Modern technologies ensure safety
            </h2>
