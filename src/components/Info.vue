<template>
    <div class="container pt-5 mt-5">
      <div class="row">
        <div class="col-8">
          <div class="row lg-3">
            <h2 class="info-item-title text-left font-weight-bold mb-2 pb-2">
              Dential<h class="blueish">Clinic</h> is a modern<br />medical and
              dental clinic
            </h2>
            <div class="divider py-1 mb-5"></div>

            <div class="col align-items-start">
              <p class="grey-text">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias
                aliquid vel, voluptatem nulla, nostrum ullam illum harum suscipit
                veniam saepe itaque blanditiis tempora a ad assumenda pariatur?
                Doloremque dolorem rerum ullam reiciendis.
              </p>
              <p class="grey-text">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi
                unde, nam quo a architecto molestias veritatis illo deserunt modi
                aspernatur? Mollitia saepe velit odio itaque delectus
                necessitatibus autem, unde sed?
              </p>
              ...
              <div class="container p-0 mt-5">
                <div class="row">
                  ...
                  <div class="col">
                    <h1 class="blueish">
                      12 890
                      <p class="undertext">Performed treatments</p>
                    </h1>
                  </div>
                  <div class="col">
                    <h1 class="blueish">
